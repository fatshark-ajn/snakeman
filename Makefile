...
CORE_SOURCES := src/core/game.c src/core/scoring.c src/core/state.c
GAME_SOURCES := src/main.c src/platform/sdl_app.c $(CORE_SOURCES)
TEST_SOURCES := tests/test_framework.c tests/test_main.c tests/test_state.c tests/test_scoring.c $(CORE_SOURCES)
